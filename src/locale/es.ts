...
export const es: Locale = {
  ...
  words: {
    ...
    negative: 'menos',
    // Only used between tens and units within a single 0-999 group ("treinta y cinco"),
    // never between scale groups — left as vocabulary for the not-yet-written chunk
    // builder (see `Locale.words.and`'s doc comment in `types.ts`).
    and: 'y',
